...
def parse_args():
    ...
    parser.add_argument("--point_num", type=int, default=10, help="point num")
...
def main(args,box_epo):
    ...
    test_dataset = TestingDataset(data_path=args.data_path, image_size=args.image_size, mode='test', requires_name=True, point_num=args.point_num, return_ori_mask=True, prompt_path=args.prompt_path,max_pixel=max_pixel,choice=choice)
    ...
    for i, batched_input in enumerate(test_pbar):
        ...
        if args.boxes_prompt:
            ...
            save_path= os.path.join(args.work_dir, args.run_name,f"box_{choice}_{box_epo}")
